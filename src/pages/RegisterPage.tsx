...
import { Mail, Lock, User, Phone, Star, ArrowRight, ArrowLeft } from 'lucide-react';
...
export function RegisterPage() {
  ...
  return <div className="min-h-screen w-full bg-[#3742FA] flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <Link
      to="/"
      className="absolute bottom-8 left-8 flex items-center gap-2 text-white font-black hover:text-yellow-300 transition-all group"
    >
