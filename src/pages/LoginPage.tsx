...
export function LoginPage() {
  ...
  return <div className="min-h-screen w-full bg-[#FFA502] flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="w-full max-w-md bg-white border-4 border-black rounded-xl shadow-[12px_12px_0px_0px_#000] relative z-10 overflow-hidden">
        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            })} icon={<Lock size={20} strokeWidth={3} />} required />
            ...
            <div className="flex items-center gap-2 mb-4">
              <div className="relative flex items-center">
                <input type="checkbox" id="remember" className="peer h-6 w-6 appearance-none border-4 border-black rounded bg-white checked:bg-[#3742FA] checked:border-black transition-all cursor-pointer" />
            ...
            <MangaButton variant="primary" className="w-full text-xl py-4" type="submit">
              {isLoading ? <IntlText en="LOADING..." ja="読み込み中..." vi="Đang tải..." /> : <IntlText en="LOGIN NOW!" ja="今すぐログイン!" vi="Đăng nhập ngay!" />}
            </MangaButton>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button type="button" className="flex items-center justify-center gap-2 p-3 border-4 border-black rounded-lg bg-[#1877F2] hover:bg-[#166FE5] text-white transition-all font-black shadow-[4px_4px_0px_0px_#000] hover:shadow-[6px_6px_0px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px]">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
                <span className="hidden sm:inline">FACEBOOK</span>
              </button>
              <button type="button" className="flex items-center justify-center gap-2 p-3 border-4 border-black rounded-lg bg-white hover:bg-gray-50 transition-all font-black shadow-[4px_4px_0px_0px_#000] hover:shadow-[6px_6px_0px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px]">
