      ...
      <div className="flex items-center justify-between h-20">
        ...
        <div className="flex items-center space-x-3 flex-shrink-0">
          <motion.div className="hidden md:flex relative" initial={{
            ...
            <input type="text" placeholder={lang === 'ja' ? '検索...' : lang === 'vi' ? 'Tìm kiếm...' : 'Search...'} className="w-48 pl-4 pr-10 py-2 border-3 border-anime-black font-bold focus:outline-none focus:shadow-pop-yellow transition-shadow" />
